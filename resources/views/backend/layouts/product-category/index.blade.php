                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-header d-flex justify-content-between align-items-center">
                            <h5 class="card-title mb-0">All Product Category List</h5>
                                ...
                                <table id="datatable"
                                    ...
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="column-content">Product Category Name</th>
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#createServiceForm').submit(function(e) {
                ...
                axios.post("{{ route('product-category.store') }}", formData)
            ...
            $(document).on('click', '.edit-service', function() {
                ...
                $('#edit_services_name').val(rowData.name);
            ...
            $('#editServiceForm').submit(function(e) {
                ...
                axios.put("{{ route('product-category.update', 0) }}".replace('/0', '/' + serviceId),
                        formData)
                    .then(function(response) {
        ...
        function statusChange(id) {
            let url = '{{ route('product-category.status', 0) }}'.replace('/0', '/' + id);
            $.ajax({
                type: "GET",
                url: url,
        ...
        function deleteItem(id) {
            let url = '{{ route('product-category.destroy', 0) }}'.replace('/0', '/' + id);
