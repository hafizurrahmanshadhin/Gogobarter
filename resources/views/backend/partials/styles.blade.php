...
<link rel="shortcut icon" type="image/x-icon"
    href="{{ isset($systemSetting->favicon) && !empty($systemSetting->favicon) ? asset($systemSetting->favicon) : asset('frontend/icons/success-icon.svg') }}" />
...
<link rel="stylesheet" type="text/css" href="{{ asset('backend/custom_downloaded_file/dropify.css') }}">
...
{{-- Bootstrap CSS --}}
<link href="{{ asset('backend/custom_downloaded_file/bootstrap.min.css') }}" rel="stylesheet">

{{-- DataTables CSS --}}
<link href="{{ asset('backend/custom_downloaded_file/dataTables.bootstrap5.min.css') }}" rel="stylesheet">

{{-- Custom CSS for DataTable Start --}}
<style>
    .text-center {
        text-align: center;
    }
    ...
    table.dataTable th.column-id,
    table.dataTable td.column-id,
    table.dataTable th.column-status,
    table.dataTable td.column-status,
    table.dataTable th.column-action,
